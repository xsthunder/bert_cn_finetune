...
from models.pytorch_modeling import BertConfig, BertForMultipleChoice, ALBertConfig, ALBertForMultipleChoice
...
def main():
    ...
    parser.add_argument("--data_dir",
                        default='origin_data/C3',
                        type=str)
    parser.add_argument("--task_name",
                        default='c3',
                        type=str)
    parser.add_argument("--bert_config_file",  # albert_xxlarge_google_zh_v1121 # roberta_wwm_ext_large
    ...
    for seed in args.seed:
        args.output_dir = passed_output_dir +f"_seed_{seed}"
        os.makedirs(args.output_dir , exist_ok=True)
